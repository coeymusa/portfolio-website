...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      'A private SaaS for couples. Upload your photos, write the story, and the AI designs a one-of-a-kind website that gets deployed to your own subdomain — no template, no two alike. "Cariad" is Welsh for "love"; the marketing pages lean into Welsh heritage with hand-drawn SVG plates and genealogy. Multi-subdomain rendering, Stripe billing with a 14-day refund window, AI spend tracked per couple/site/operation, and a paywalled public-share view for the recipient.',
    techStack: [
      { name: 'Next.js 16', category: 'frontend' },
      { name: 'TypeScript', category: 'frontend' },
      { name: 'Tailwind v4', category: 'frontend' },
    ...
    features: [
      'AI generates a one-of-one website spec from each couple\'s photos and words',
      'Multi-subdomain rendering — every site lives at its own [name].cariadletters.com',
      'Photo pipeline direct to AWS S3 (eu-west-1) with per-couple isolation',
      'Stripe billing with 14-day refund policy and AI-spend instrumentation per operation',
      'Built end-to-end in a single evening — 14 commits between 17:41 and 22:44 UTC',
    ],
    ...
    theme: 'global-atlas',
    accent: '#e4846b',
    previewCaption: 'fig. 10 — cariadletters.com · live',
    hideSpecimen: true,
    specimen: {
      kind: 'global-atlas',
      data: {
