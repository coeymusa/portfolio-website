...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'cariadletters',
    title: 'Cariad Letters',
    tagline: 'A private, custom-designed website for couples — generated by AI from photos and words',
    description:
      'A private SaaS for couples. Upload your photos, write the story, and AI designs a one-of-a-kind website — choose from multiple design languages (polaroid, magazine, cinematic, editorial), translated into eight languages, deployed to your own subdomain. "Cariad" is Welsh for "love"; the marketing leans into Welsh heritage. Public Lookbook of styled demos, geo-detected currency, AI-spend tracked per operation, Clerk satellite-domain auth, and a paywalled public-share for the recipient. Launched in a single evening; 70+ commits in the first week of post-launch work.',
    techStack: [
      { name: 'Next.js 16', category: 'frontend' },
      { name: 'TypeScript', category: 'frontend' },
      { name: 'Tailwind v4', category: 'frontend' },
      { name: 'i18n · 8 langs', category: 'frontend' },
      { name: 'Clerk', category: 'api' },
      { name: 'Supabase', category: 'database' },
    ...
    features: [
      'AI generates a one-of-one site from each couple\'s photos and words across multiple design languages (polaroid, magazine, cinematic, editorial)',
      'Available in 8 languages — cookie-based locale, full dictionary translation, locale carried through to the AI prose generator',
      'Public Lookbook of demo couples in every style — Aled & Brân (Aberystwyth → Cardiff → Eryri) leads, with magazine/cinematic/editorial seeds for preview-before-signup',
      'Multi-subdomain rendering — every site at [name].cariadletters.com with Clerk satellite-domain auth and reserved-subdomain guards',
      'Geo-detected currency on marketing and billing; Stripe with 14-day refund and AI-spend instrumentation per couple, site, and operation',
    ],
    liveUrl: 'https://cariadletters.com',
    category: 'saas',
    gradient: 'linear-gradient(135deg, #e4846b, #c9a961)',
    icon: '<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>',
    theme: 'global-atlas',
    accent: '#e4846b',
    previewCaption: 'fig. 10 — cariadletters.com · live · 8 languages',
    hideSpecimen: true,
    specimen: {
      kind: 'global-atlas',
      data: {
        voices: 'PRIVATE',
        countries: 'CYMRU · 8 LANGS',
        latest: 'one-of-one · per couple',
        signal: '· DELIVERED',
      },
    },
  },
  {
    id: 'removeclaudewhitespace',
    title: 'Remove Claude Whitespace',
    tagline: 'A free, single-page tool that cleans messy output from Claude Code, AI assistants, and terminals',
    description:
      'A focused utility for the small daily problem of pasting AI output into Slack, an email, a doc, or a Reddit reply and discovering the formatting is broken. Strips line numbers, ANSI escapes, box-drawing characters, and ragged whitespace; a Markdown / Reddit mode normalises paragraphs for cross-posting. Runs entirely in the browser — text never leaves the page, no server, no logs. Built and deployed in a single afternoon.',
    techStack: [
    ...
    features: [
      'Strips line numbers, ANSI escapes, box-drawing characters, and ragged whitespace from any pasted block',
      'Markdown / Reddit mode normalises paragraphs for clean cross-posting',
      '100% client-side — text never leaves the browser, no server, no telemetry on the input',
      'SEO-tuned landing with Vercel Web Analytics from day one; quiet traffic funnel to other projects',
    ],
    ...
    theme: 'service-stamp',
    accent: '#818cf8',
    previewCaption: 'fig. 11 — removeclaudewhitespace.com · live',
    hideSpecimen: true,
    specimen: {
      kind: 'service-stamp',
      data: {
        intake: 'Messy AI paste',
        shipped: 'Clean text',
        days: '0',
        guarantee: 'Client-side · No server · MIT',
      },
    },
  },
];
